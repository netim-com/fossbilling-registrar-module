...
class Registrar_Adapter_Netim extends Registrar_AdapterAbstract
{
    ...
    private function _prepareContactInfo(Registrar_Domain $domain, $owner = 1)
    {
        ...
        $contact = new NormalizedContact($firstname, $lastname, $bodyName, $address1, $zipCode, $area, $country, $city, $phone, $email, $language, $isOwner, $address2, $tmName, $tmNumber, $tmType, $tmDate, $companyNumber, $vatNumber, $birthDate, $birthZipCode, $birthCity, $birthCountry, $idNumber, $additional);
